...
<div class="profile-header" style="background-image: url('../admin/barangayimage/<?=$rowdesign['DASHBOARD_IMAGE']?>');">
    <img src="images/<?=$row['PROFILE']?>" class="profile-avatar" alt="Profile">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="profile-info">
                        ...
                        <div class="profile-info-item">
                            <div class="profile-info-label">
                                <i class="fas fa-briefcase mr-2 text-primary"></i>Usertype
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            <div class="card p-3 shadow-sm">
                                ...
                                <img id="profilePreview" src="images/<?= $row['PROFILE'] ?>" class="img-thumbnail" style="width: auto; height: auto;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position" required>
                                            ...
                                            <option value="User" <?= ($row['USERTYPE'] == 'User') ? 'selected' : '' ?>>User</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
