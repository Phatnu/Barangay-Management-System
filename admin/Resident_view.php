...
if(isset($_POST['update_resident'])){
   ...
   if (!empty($_FILES['profile']['name'])) {
    ...
    if (move_uploaded_file($_FILES['profile']['tmp_name'], $profile)) {
        ...
        $profile = mysqli_real_escape_string($con, $_POST['existing_profile']); // Keep the old profile
    }


    $updatequery = "UPDATE RESIDENT SET FIRST_NAME='$first_name ',MIDDLE_NAME='$middle_name',LAST_NAME='$last_name',ALIAS='$alias',PLACE_OF_BIRTH='$place_of_birth',BIRTH_DATE='$birth_date',AGE='$age',CIVIL_STATUS='$civil_status',GENDER='$gender',PUROK='$purok',VOTER_STATUS='$voter_status',PHONE='$phone',EMAIL='$email', PROFILE='$profile' WHERE RESIDENT_ID = '$restid'";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="profile-sidebar mb-4">
                            <div class="mb-4">
                                <img src="Profile/<?=$row['PROFILE']?>" alt="Profile Picture" class="profile-img mb-3">
                            </div>
                    ...
                    <div class="tab-content" id="residentInfoTabsContent">
                        ...
                        <div class="row d-flex justify-content-center mb-2 position-relative">
                                <div class="profile-container">
                                    <!-- Profile image -->
                                    <img id="profilePreview" src="ProFile/<?=$row['PROFILE']?>" alt="" class="profile-img">
