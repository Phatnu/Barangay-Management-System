...
<div style="border-left: 5px solid #0d6efd; padding-left: 10px;">
  <h5 style="margin: 0; font-weight: 600; color: #333;">
    ...
    <span style="color: #0d6efd;">(<?php echo $total_brgy; ?>)</span>
  </h5>
</div>
...
<table class="table table-bordered custom-table table-striped" id="myTable">
    ...
    <?php while ($row = $resident->fetch_assoc()) { ?>
        <tr>
            ...
            <a style="color:green" href="Certificate.php?id=<?=$row['RESIDENT_ID'] ?>" target="_blank"><i style="font-size:.9rem;color:green" class="fas fa-fw fa-file-alt"></i>GENERATE</a>
